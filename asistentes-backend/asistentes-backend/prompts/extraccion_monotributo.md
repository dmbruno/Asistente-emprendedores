...
El cliente que recibe este servicio es MONOTRIBUTISTA. Como monotributista no liquida IVA: los montos incluyen todo sin discriminar alícuotas. Igual intentá extraer iva_21/iva_10_5/iva_27 si aparecen explícitamente en el comprobante (ej: factura tipo A de un proveedor RI), pero no es obligatorio.
