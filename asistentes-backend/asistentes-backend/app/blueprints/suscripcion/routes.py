...
def checkout():
    ...
    # En sandbox no forzamos payer_email para que el Buyer Test User pueda loguearse
    if not is_sandbox and email:
        preapproval_data["payer_email"] = email
    ...
    # En sandbox usar sandbox_init_point si está disponible (evita cargar la cuenta real)
    if is_sandbox:
